...
1. Install your editor extension:
    ...
    <ul>
      <li> <a href="https://github.com/falstro/ghost-text-vim">Vim <b>Tcl</b> Script</a><br>
      (needs Vim compiled with +tcl)<br>
      <li> <a href="https://github.com/pandysong/ghost-text.vim"><b>Vim-only</b> plugin written in python</a><br>
      (needs Vim compiled with +python3)<br>
      <li> <a href="https://github.com/raghur/vim-ghost">Python remote plugin supporting both <b>Vim</b> and <b>Neovim</b></a><br>
      (needs Vim compiled with +python3 or Neovim with correctly-set-up python connectivity)<br>
      <li> <a href="https://github.com/subnut/nvim-ghost.nvim"><b>Neovim-only</b> plugin with <b>zero dependencies</b></a><br>
      (needs nothing except neovim)<br>
    </ul>
    </details>
